...
Base = 'http://pastebin.com/raw/q1Qd61hU' #    modificar("la ruta de tus listas")

addon = xbmcaddon.Addon('plugin.video.TOTO-IPTV') #    modificar("el nombre de tu addons")
addon_version = addon.getAddonInfo('1.0.O')    #    modificar("la version de tu addons")
